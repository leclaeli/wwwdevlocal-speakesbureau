...
$lcp_display_output .= '<ul class="lcp_catlist iamuwm-videos">';
...
foreach ($this->catlist->get_categories_posts() as $single){
  ...
  //link to IAMUWM youtube:
  $youtube_link = get_post_meta( $single->ID, 'iamuwm-youtube', true );
  $lcp_display_output .= "<a class='youtube-link' href='$youtube_link'></a>";
